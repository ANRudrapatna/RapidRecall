...
After loading the track data hub (link [here]) in "My Data" > "Track Hubs" on the [UCSC Genome Browser website](https://genome.ucsc.edu/index.html), you can select specific genomic locations to visualize all subpopulation-resolved maxATAC predictions and chromatin accessibility information in that area. The image below shows the promoter and gene body of :
